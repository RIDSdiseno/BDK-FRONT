...
import { footerContent } from '../../dominios/sitio/datosPiePagina'
import { siteConfig } from '../../dominios/sitio/datosSitio'
...
export const PiePagina = () => {
  return (
    <footer className="bg-gradient-to-br from-[#0A1226] via-bdk-navy to-[#0E2347] text-white">
      <Contenedor className="grid gap-10 py-16 lg:grid-cols-[1.2fr_2fr]">
      ...
      <div className="border-t border-bdk-orange/20">
        <Contenedor className={cn('py-6 text-xs text-slate-300')}>
          {footerContent.legal}
        </Contenedor>
      </div>
    </footer>
