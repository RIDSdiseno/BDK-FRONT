...
import { navCta, navLabels, navLinks } from '../../dominios/sitio/datosNavegacion'
...
export const BarraNavegacion = () => {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur">
      <Contenedor className="flex items-center justify-between py-4">
      ...
      <AnimatePresence initial={false}>
        {isOpen ? (
          ...
          >
            <Contenedor className="space-y-5 py-6">
