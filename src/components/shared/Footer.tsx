...
const renderFooterLink = (label: string, href?: string) => {
  const classes =
    'text-sm text-slate-200 transition hover:text-bdk-yellow'
...
export const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-[#0A1226] via-bdk-navy to-[#0C1F42] text-white">
            ...
            {footerContent.socialLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-bdk-yellow/40 text-slate-200 transition hover:border-bdk-yellow hover:text-bdk-yellow"
                >
      ...
      <div className="border-t border-bdk-yellow/20">
